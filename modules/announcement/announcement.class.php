...
class TAnnouncement {
	...
	var $table = 'objects'; //данные из временной таблицы
...
//						$success_plan = true;
	...
	function step2() {
		...
		if (!isset($GLOBALS['_SESSION']['new_announce']['fields']) || !count($GLOBALS['_SESSION']['new_announce']['fields'])) redirect('/add');
	...
	function show_user_anno() {
		...
		$ret['add_object_link'] = '/add';
		$ret['edit_object_link'] = 'announcement';
