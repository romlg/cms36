...
*  License Information:
*
*    Excel_Writer:  A library for generating Excel s
...
/**
* @const EXCEL_WRITER_ADD token identifier for character "+"
*/
define('EXCEL_WRITER_ADD', "+");

/**
* @const EXCEL_WRITER_SUB token identifier for character "-"
*/
define('EXCEL_WRITER_SUB', "-");

/**
* @const EXCEL_WRITER_MUL token identifier for character "*"
*/
define('EXCEL_WRITER_MUL', "*");

/**
* @const EXCEL_WRITER_DIV token identifier for character "/"
*/
define('EXCEL_WRITER_DIV', "/");

/**
* @const EXCEL_WRITER_OPEN token identifier for character "("
*/
define('EXCEL_WRITER_OPEN', "(");

/**
* @const EXCEL_WRITER_CLOSE token identifier for character ")"
*/
define('EXCEL_WRITER_CLOSE', ")");

/**
* @const EXCEL_WRITER_COMA token identifier for character ","
*/
define('EXCEL_WRITER_COMA', ",");

/**
* @const EXCEL_WRITER_SEMICOLON token identifier for character ";"
*/
define('EXCEL_WRITER_SEMICOLON', ";");

/**
* @const EXCEL_WRITER_GT token identifier for character ">"
*/
define('EXCEL_WRITER_GT', ">");

/**
* @const EXCEL_WRITER_LT token identifier for character "<"
*/
define('EXCEL_WRITER_LT', "<");

/**
* @const EXCEL_WRITER_LE token identifier for character "<="
*/
define('EXCEL_WRITER_LE', "<=");

/**
* @const EXCEL_WRITER_GE token identifier for character ">="
*/
define('EXCEL_WRITER_GE', ">=");

/**
* @const EXCEL_WRITER_EQ token identifier for character "="
*/
define('EXCEL_WRITER_EQ', "=");

/**
* @const EXCEL_WRITER_NE token identifier for character "<>"
*/
define('EXCEL_WRITER_NE', "<>");
...
class Excel_Writer_Parser extends PEAR
{
    /**
    ...
    */
    ...
    {
        switch($token) {
            case EXCEL_WRITER_ADD:
                return $token;
                break;
            case EXCEL_WRITER_SUB:
                return $token;
                break;
            case EXCEL_WRITER_MUL:
                return $token;
                break;
            case EXCEL_WRITER_DIV:
                return $token;
                break;
            case EXCEL_WRITER_OPEN:
                return $token;
                break;
            case EXCEL_WRITER_CLOSE:
                return $token;
                break;
            case EXCEL_WRITER_COMA:
                return $token;
                break;
            case EXCEL_WRITER_SEMICOLON:
                return $token;
                break;
            case EXCEL_WRITER_GT:
                if ($this->_lookahead == '=') { // it's a GE token
                    break;
                }
                return $token;
                break;
            case EXCEL_WRITER_LT:
                ...
                return $token;
                break;
            case EXCEL_WRITER_GE:
                return $token;
                break;
            case EXCEL_WRITER_LE:
                return $token;
                break;
            case EXCEL_WRITER_EQ:
                return $token;
                break;
            case EXCEL_WRITER_NE:
                return $token;
                break;
            default:
                // if it's a reference
    ...
    */
    function _condition()
    {
        ...
        if ($this->_current_token == EXCEL_WRITER_LT) {
            $this->_advance();
        ...
        } elseif ($this->_current_token == EXCEL_WRITER_GT) {
            $this->_advance();
            $result2 = $this->_expression();
            if (PEAR::isError($result2)) {
                return $result2;
        ...
        } elseif ($this->_current_token == EXCEL_WRITER_LE) {
            $this->_advance();
            $result2 = $this->_expression();
            if (PEAR::isError($result2)) {
                return $result2;
        ...
        } elseif ($this->_current_token == EXCEL_WRITER_GE) {
            $this->_advance();
            $result2 = $this->_expression();
            if (PEAR::isError($result2)) {
                return $result2;
        ...
        } elseif ($this->_current_token == EXCEL_WRITER_EQ) {
            $this->_advance();
            $result2 = $this->_expression();
            if (PEAR::isError($result2)) {
                return $result2;
        ...
        } elseif ($this->_current_token == EXCEL_WRITER_NE) {
            $this->_advance();
            $result2 = $this->_expression();
            if (PEAR::isError($result2)) {
                return $result2;
    ...
    */
    function _expression()
    {
        ...
        if (ereg("^\"[^\"]{0,255}\"$", $this->_current_token)) {
            ...
            $this->_advance();
            return $result;
        } elseif ($this->_current_token == EXCEL_WRITER_SUB) {
            // catch "-" Term
            $this->_advance();
            $result2 = $this->_expression();
        ...
        while (($this->_current_token == EXCEL_WRITER_ADD) or
               ($this->_current_token == EXCEL_WRITER_SUB)) {
        /**/
            if ($this->_current_token == EXCEL_WRITER_ADD) {
                $this->_advance();
                $result2 = $this->_term();
                if (PEAR::isError($result2)) {
                    return $result2;
    ...
    */
    function _term()
    {
        ...
        while (($this->_current_token == EXCEL_WRITER_MUL) or
               ($this->_current_token == EXCEL_WRITER_DIV)) {
        /**/
            if ($this->_current_token == EXCEL_WRITER_MUL) {
                $this->_advance();
                $result2 = $this->_fact();
                if (PEAR::isError($result2)) {
                    return $result2;
    ...
    */
    function _fact()
    {
        if ($this->_current_token == EXCEL_WRITER_OPEN) {
            $this->_advance();         // eat the "("
            $result = $this->_parenthesizedExpression();
            if ($this->_current_token != EXCEL_WRITER_CLOSE) {
    ...
    */
    function _func()
    {
        ...
        /**/
            if ($num_args > 0) {
                if ($this->_current_token == EXCEL_WRITER_COMA or
                    $this->_current_token == EXCEL_WRITER_SEMICOLON)
                {
