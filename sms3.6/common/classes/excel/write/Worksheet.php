...
*  PERL ::WriteExcel module.
*
*  The author of the ::WriteExcel module is John McNamara
*  <jmcnamara@cpan.org>
*
...
class Excel_Writer_Worksheet extends Excel_Writer_BIFFwriter
{
    ...
    */
    ...
    /**
    * Maximum number of rows for an Excel  (BIFF5)
    * @var integer
    */
    var $_xls_rowmax;

    /**
    * Maximum number of columns for an Excel  (BIFF5)
    * @var integer
    */
    var $_xls_colmax;
    ...
    */
    function _initialize()
    {
        ...
        $fh = fopen(tempnam(PATH_CACHE."tmp", "xls"), "x");
        if ($fh) {
            // Store filehandle
            $this->_filehandle = $fh;
        } else {
