...
/*
  ...
  $worksheet1 =& $workbook->add_worksheet('Movitex');
  ...
  $worksheet1->set_selection(2,1,5,6);
  //-----------------------------------------------------------------------------------
  /* 
  *  замораживаем линию
  *  передается массив из 5 элементов:
  *  array(
  *  	$firstRow,
  *  	$firstColumn,
  *  	$lastRow,
  *  	$lastColumn,
  *  	$type = 0 => Vertical split position,
  ...
  *);
  ...
  /*$worksheet1->freeze_panes(array(8, 0, 10, 1, 0));
   $worksheet1->freeze_panes(array(12, 3, 15, 4, 1));
   $worksheet1->freeze_panes(array(16, 5, 18, 6, 2));
   $worksheet1->freeze_panes(array(20, 7, 23, 9, 3));
   $worksheet1->_store_panes(array(8, 2, 12, 5, 4));
  //-----------------------------------------------------------------------------------
  $worksheet1->setOutline();
