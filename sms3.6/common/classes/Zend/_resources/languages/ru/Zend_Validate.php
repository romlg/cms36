...
return array(
    ...
    "'%value%' is no valid email address in the basic format local-part@hostname" => "Не забудьте символ '@' (например, myname@example.com).",
...
//    "Value is required and can't be empty" => "Значение обязательно для заполнения и не может быть пустым",
    ...
    "Captcha value is wrong" => "Проверочный текст введен неверно. Повторите попытку.",

    // Zend_Validate_Phone_Number
    "Incorrect Phone Number" => "Неизвестный формат телефона. Убедитесь, вы правильно ввели номер телефона с кодом города (например: +7 495 5555555).",
);
