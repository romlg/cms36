...
return array(
    ...
    "'%value%' is no valid email address in the basic format local-part@hostname" => "Don't forget to include the '@'. e.g. myname@example.com.",
    ...
    "Value is required and can't be empty" => "Required field cannot be left blank.",
    ...
    "Captcha value is wrong" => "The characters that you entered didn't match the word verification. Please try again. ",

    // Zend_Validate_Phone_Number
    "Incorrect Phone Number" => "This phone number format is not recognised. Please check the country code and number (for example: +7 495 5555555).",
);
