...
class Zend_View_Helper_FormSubmit extends Zend_View_Helper_FormElement
{
    ...
    public function formSubmit($name, $value = null, $attribs = null)
    {
        ...
        $xhtml = '<div class="clear"></div><a href="javascript:void(0);" class="button noCn" onclick="jQuery(this).parent(\'form\').submit(); return false;"'
                       . ' name="' . $this->view->escape($name) . '"'
                       . $id
                       . $disabled
                       . $this->_htmlAttribs($attribs)
                       . '><span class="bg">' . $this->view->escape($value) . '</span></a>';
