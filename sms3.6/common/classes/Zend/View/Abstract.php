...
/** @see Zend_Loader */
require_once (PATH_COMMON_CLASSES.'Zend/Loader.php');

/** @see Zend_Loader_PluginLoader */
require_once (PATH_COMMON_CLASSES.'Zend/Loader/PluginLoader.php');

/** @see Zend_View_Interface */
require_once (PATH_COMMON_CLASSES.'Zend/View/Interface.php');
...
abstract class Zend_View_Abstract implements Zend_View_Interface
{
    ...
    public function __set($key, $val)
    {
        ...
        require_once (PATH_COMMON_CLASSES.'Zend/View/Exception.php');
    ...
    //function _addPath($type, $path, $prefix = null)
    {
