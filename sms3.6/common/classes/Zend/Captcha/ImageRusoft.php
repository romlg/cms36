...
/** @see Zend_Captcha_WordRusoft */
require_once 'Zend/Captcha/WordRusoft.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Captcha_ImageRusoft extends Zend_Captcha_WordRusoft
{
    /**
     ...
     * @var string
     */
    protected $_imgDir = "./files/captcha/";
     ...
     * @var string
     */
    protected $_imgUrl = "/files/captcha/";
   ...
   /**
    ...
    public function render(Zend_View_Interface $view = null, $element = null)
    {
        ...
        return '<img class="captcha" width="' . $this->getWidth() . '" height="' . $this->getHeight() . '" alt="' . $this->getImgAlt()
