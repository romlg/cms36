 ...
 */
abstract class Zend_Captcha_WordRusoft extends Zend_Captcha_Base
{
    /**#@+
    ...
    /**
     * Имя переменной в сесии
     * @var string
     */
    protected $_session_name = 'captcha_string';
    ...
    {
        if (empty($this->_word)) {
            $this->_word = $_SESSION[$this->_session_name];
        }
        return $this->_word;
    }
    ...
    {
        $_SESSION[$this->_session_name] = $word;
        $this->_word   = $word;
        return $this;
    }
