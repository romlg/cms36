    ...
    public function render(Zend_View_Interface $view = null)
    {
        ...
        if (!$this->loadDefaultDecoratorsIsDisabled()) {
            ...
            if (!empty($decorator) && !array_key_exists($key, $decorators)) {
                ...
                $decorators = array();
                $decorators['Zend_Form_Decorator_Label'] = $temp['Zend_Form_Decorator_Label'];
                $decorators['Zend_Form_Decorator_FormErrors'] = $temp['Zend_Form_Decorator_FormErrors'];
                $decorators['Zend_Form_Decorator_Errors'] = $temp['Zend_Form_Decorator_Errors'];
                $decorators['Zend_Form_Decorator_Captcha'] = $temp['Zend_Form_Decorator_Captcha'];
                $decorators[] = $decorator;
                $decorators['Zend_Form_Decorator_Description'] = $temp['Zend_Form_Decorator_Description'];
