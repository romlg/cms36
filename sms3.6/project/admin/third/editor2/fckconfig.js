...
FCKConfig.HelpLink = '/admin/act.php?page=help&do=showhelp&module=fck.show';
...
FCKConfig.ToolbarSets["Default"] = [
	...
	['Link','Unlink','Anchor','OrderedList','UnorderedList'],
	['Image','Table','Rule','Smiley','SpecialChar','PageBreak','TextColor','BGColor'],
	['Style','FontFormat','FontSize']
] ;

//FCKConfig.ToolbarSets["Default"] = [
//	['Source','Cut','Copy','Paste','PasteText','PasteWord','-','Undo','Redo','-','SelectAll','RemoveWordF','-','Link','RemoveLink','Anchor','-','Image','Table','Rule','SpecialChar',],
...
FCKConfig.ToolbarSets["Simple"] = [
	...
	['Link','Unlink','Anchor','OrderedList','UnorderedList','Image','TextColor','BGColor'],
	['Style','FontFormat','FontSize']
] ;
...
FCKConfig.ToolbarSets["Common"] = [
	...
	['Link','Unlink','Anchor','OrderedList','UnorderedList','Image','Table','Cite','TextColor','BGColor'],
	['Style','FontFormat','FontSize']
] ;
...
FCKConfig.StylesXmlPath		= FCKConfig.EditorPath + '../../css_custom/fckstyle.xml';
