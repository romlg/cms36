...
lang["UniversalKeyboard"]	= "Универсальная клавиатура" ;
...
lang["FontStyleAdv"]		= "Расширенный стиль шрифта" ;
...
lang["RadioButton"]		= "Радио кнопка" ;
lang["TextField"]		= "Текстовое поле" ;
lang["Textarea"]		= "Текстовая область" ;
lang["HiddenField"]		= "Скрытое поле" ;
lang["Button"]			= "Кнопка" ;
lang["SelectionField"]		= "Поле со списком" ;
lang["ImageButton"]		= "Кнопка с рисунком" ;
...
lang["AnchorProperties"]	= "Свойства якоря" ;
lang["ButtonProperties"]	= "Свойства кнопки" ;
lang["CheckboxProperties"]	= "Свойства флажка" ;
lang["HiddenFieldProperties"]	= "Свойства скрытого поля" ;
lang["RadioButtonProperties"]	= "Свойства радио кнопки" ;
lang["ImageButtonProperties"]	= "Свойства кнопки с рисунком" ;
lang["FieldProperties"]		= "Свойства поля" ;
lang["SelectionFieldProperties"]= "Свойства поля со списком" ;
lang["TextareaProperties"]	= "Свойства текстовой области" ;
lang["FormProperties"]		= "Свойства формы" ;
...
lang["NoSpellCheck"]		= "Проверка орфографии не может быть выполнена на этом компьютере." ;
lang["DownloadSpellChecker"]	= "Компонент проверки орфографии не установлен. Загрузить сейчас?" ;
lang["SpellCheckFinished"]	= "Проверка орфографии закончена." ;
...
lang["DlgImgURL"]			= "Маленькая картинка (URL)" ;
lang["DlgAddImgURL"]		= "Большая картинка (URL)" ;
...
lang["DlgImgBorder"]		= "Граница" ;
lang["DlgImgHSpace"]		= "Поле по горизонтали" ;
lang["DlgImgVSpace"]		= "Поле по вертикали" ;
lang["DlgImgAlign"]		= "Выравнивание" ;
lang["DlgImgAlignLeft"]		= "По левому краю" ;
lang["DlgImgAlignAbsBottom"]	= "По низу абс." ;
lang["DlgImgAlignAbsMiddle"]	= "По центру абс." ;
lang["DlgImgAlignBaseline"]	= "По основанию" ;
lang["DlgImgAlignBottom"]	= "По низу" ;
lang["DlgImgAlignMiddle"]	= "По центру" ;
lang["DlgImgAlignRight"]	= "По правому краю" ;
lang["DlgImgAlignTextTop"]	= "По верху текста" ;
lang["DlgImgAlignTop"]		= "По верху" ;
...
lang["DlgImgAlertSelect"]	= "Пожалуйста, выберите рисунок для загрузки." ;

// Link Dialog
lang["AlignLeft"]	= "Выровнять по левому краю" ;
lang["AlignRight"]	= "Выровнять по правому краю" ;
lang["DlgLnkWindowTitle"]	= "Гиперссылка" ;
lang["DlgLinkTitleInsert"]	= "Создание гиперссылки" ;
lang["DlgLinkTitleEdit"]	= "Свойства гиперссылки" ;
lang["DlgLnkURL"]			= "Адрес" ;
lang["DlgLnkBtnSiteLink"]	= "Ссылка на раздел" ;
lang["DlgLnkBtnFileLink"]	= "Ссылка на файл" ;
...
lang["DlgCellVerAlignBaseline"]	= "Основание" ;
lang["DlgCellRowSpan"]		= "RowSpan" ;
lang["DlgCellCollSpan"]		= "ColSpan" ;
...
lang["DlgAboutLicense"]		= "Условия лицензирования: GNU Lesser General Public License" ;
lang["DlgAboutInfo"]		= "Дополнительная информация доступна по адресу" ;

// Anchor Dialog
lang["DlgAnchorTitle"]		= "Свойства якоря" ;
lang["DlgAnchorName"]		= "Имя якоря" ;

// Replace Dialog
lang["DlgReplaceTitle"]		= "Заменить" ;
lang["DlgReplaceFindLbl"]	= "Искать:" ;
lang["DlgReplaceReplaceLbl"]	= "Заменить на:" ;
lang["DlgReplaceCaseChk"]	= "Учитывать регистр" ;
lang["DlgReplaceReplaceBtn"]= "Заменить" ;
lang["DlgReplaceReplAllBtn"]= "Заменить все" ;

// Universal Keyboard Dialog
lang["DlgUniversalKeyTitle"]= "Универсальная клавиатура" ;

// Button Dialog
lang["DlgButtonText"]	= "Текст (Значение)" ;
lang["DlgButtonType"]	= "Тип" ;

// Checkbox and Radio Button Dialogs
lang["DlgCheckboxName"]		= "Имя" ;
lang["DlgCheckboxValue"]	= "Значение" ;
lang["DlgCheckboxSelected"]	= "Установить" ;

// Form Dialog
lang["DlgFormName"]	= "Имя" ;
lang["DlgFormAction"]	= "Действие" ;
lang["DlgFormMethod"]	= "Метод" ;

// Select Field Dialog
lang["DlgSelectName"]		= "Имя" ;
lang["DlgSelectValue"]		= "Значение" ;
lang["DlgSelectSize"]		= "Размер" ;
lang["DlgSelectLines"]		= "линии" ;
lang["DlgSelectChkMulti"]	= "Разрешить мультивыбор" ;
lang["DlgSelectOpAvail"]	= "Доступные опции" ;
lang["DlgSelectOpText"]		= "Текст" ;
lang["DlgSelectOpValue"]	= "Значение" ;
lang["DlgSelectBtnAdd"]		= "Добавить" ;
lang["DlgSelectBtnModify"]	= "Изменить" ;
lang["DlgSelectBtnUp"]		= "Вверх" ;
lang["DlgSelectBtnDown"]	= "Вниз" ;
lang["DlgSelectBtnSetValue"]	= "Выбрать" ;
lang["DlgSelectBtnDelete"]	= "Удалить" ;

// Textarea Dialog
lang["DlgTextareaName"]	= "Имя" ;
lang["DlgTextareaCols"]	= "Столбцы" ;
lang["DlgTextareaRows"]	= "Строки" ;

// Text Field Dialog
lang["DlgTextName"]	= "Имя" ;
lang["DlgTextValue"]	= "Значение" ;
lang["DlgTextCharWidth"]= "Ширина символа" ;
lang["DlgTextMaxChars"]	= "Максимум символов" ;
lang["DlgTextType"]	= "Тип" ;
lang["DlgTextTypeText"]	= "Текст" ;
lang["DlgTextTypePass"]	= "Пароль" ;

// Hidden Field Dialog
lang["DlgHiddenName"]	= "Имя" ;
lang["DlgHiddenValue"]	= "Значение" ;

// Custom
lang["Versions"]	= "Версии текста" ;
