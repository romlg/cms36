...
function showContextMenu()
{
	...
	{
		ContextMenu[index++] = new ContextMenuSeparator() ;
		ContextMenu[index++] = new ContextMenuItem( lang['AlignLeft'], "changeAlign('left')", TBCMD_CUSTOM) ;
		ContextMenu[index++] = new ContextMenuItem( lang['AlignRight'], "changeAlign('right')", TBCMD_CUSTOM) ;
		ContextMenu[index++] = new ContextMenuSeparator() ;		
