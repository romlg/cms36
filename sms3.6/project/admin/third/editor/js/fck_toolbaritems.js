...
TBI.prototype.RemoveWordF	= new TBButton("RemoveFormat"   , lang["RemoveWordF"]		, "cleanW(objContent.DOM.selection.createRange().htmlText)") ;
...
// Font
//config.StyleNames = 'Обычный текст;';
config.StyleNames  = config.StyleNames+'Обычный текст';
config.StyleValues  = config.StyleValues+'none';
...
// Custom
TBI.prototype.Versions		= new TBButton("Versions"	, "##Versions"		, "versions()"	, TBCMD_CUSTOM);
