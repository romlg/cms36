...
//##
//config.EditorAreaCSS = config.BasePath + '../../../content.css';
config.EditorAreaCSS = 'content.css';
...
config.downToolbarSets["Source"] = [
	['EditSource'],
] ;

config.ToolbarSets["Simple"] = [
	['Bold','Italic','Underline','-','FontFormat','Font','FontSize','-','Table','SpecialChar','-','Link','RemoveLink','Anchor','-','RemoveWordF']
] ;

config.ToolbarSets["Common"] = [
	['Cut','Copy','Paste','PasteText','PasteWord','-','Undo','Redo','-','SelectAll','RemoveWordF','-','Link','RemoveLink','Anchor','-','Image','Table','Rule','SpecialChar',],
	['FontStyle','FontSize','Bold','Italic','Underline','StrikeThrough','-','Subscript','Superscript','-','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','InsertOrderedList','InsertUnorderedList','-','Outdent','Indent',]] ;
config.downToolbarSets["Common"] = [
	['EditSource','ShowDetails','ShowTableBorders','-','Zoom','Preview','Find','Replace'] ,
] ;

config.ToolbarSets["Small"] = [
	['FontStyleAdv','FontSize','-','Bold','Italic','Underline','-','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','InsertOrderedList','InsertUnorderedList','-','Outdent','Indent','-','Link','RemoveLink','-','RemoveWordF']
] ;
