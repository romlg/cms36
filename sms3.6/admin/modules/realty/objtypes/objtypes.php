...
class TObjTypes extends TObjects_base {
	...
	function TObjTypes() {
		...
		$str[get_class_name($this)] = array_merge($str[get_class_name($this)], array(
			'title'			=> array('Типы объектов',			'Object types',),
	...
	function editgetTypes(){
		...
		// Выделенный пункт
		$selected = sql_getValue('SELECT pid FROM obj_types WHERE id='.$id);
...
$GLOBALS['objtypes'] =  & Registry::get('TObjTypes');
?>