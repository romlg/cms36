...
##### Editor #####
			...
			'pages'	=> array(
				'только на следующих страницах',
				'only in the following pages',
			),
			'except' => array(
				'на всех страницах за исключением следующих',
				'anywhere except the following pages',
			),
			'priority'	=> array(
				'Приоритет',
				'Priority',
			...
			'ctr_cleared' => array(
				'CTR обнулен',
				'CTR has been cleared successfully',
			),
			'e_no_items' => array(
			...
			'e_no_title' => array(
				'Не заполнено поле "Имя баннера"',
				'Empty name of banner',
			),
		));
