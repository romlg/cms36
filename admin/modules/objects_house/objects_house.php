...
class TObjects_House extends TTable {
	...
	function TObjects_House(){
		...
		$str[get_class_name($this)] = array_merge($str[get_class_name($this)], array(
			'title'			=> array('Загородная недвижимость',		'Houses',),
	...
	function getTableData(){
		...
		$columns = array(
				...
				array(
					...
					'filter_type'	=> 'array',
					'filter_value'	=> array('' => $this->str('-все-')) + sql_getRows('SELECT id, name FROM obj_direction ORDER BY name', true),
				),
				array(
	...
	function showprintForm(){
	    ...
	    $rows['title'] = 'Загородная недвижимость';
