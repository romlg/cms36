...
class TMainElement extends TElems {
	...
	var $elem_table = "obj_class";
	var $elem_type  = "single";
	var $elem_str = array(                       //строковые константы
		'name'			=> array('Название класса',		'Title',),
	...
	var $script = "
		...
		function changeBelong(num){
			url = '/admin/page.php?page=objclass&do=editgettypes&belong='+num+'&id='+document.forms.editform.elements['id'].value;
			loadXMLDoc(url);
		}
