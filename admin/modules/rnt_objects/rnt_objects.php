...
class TRnt_objects extends TTable {

	var $name  = 'rnt_objects';
	var $table = 'rnt_objects';
	var $filter = array();

	function TRnt_objects(){
		global $str, $actions;

		TTable::TTable();

		$str[get_class_name($this)] = array_merge($str[get_class_name($this)], array(
			'title'			=> array('Аренда квартиры, комнаты','Rooms',),
			'comment'		=> array('Комментарий',				'Comment'),
			'room'			=> array('Кол-во комнат в квартире','Room in flat count'),
			'rent_room'		=> array('Кол-во комнат в аренду',	'Room count'),
...
$GLOBALS['rnt_objects'] = &Registry::get('TRnt_objects');
