...
class TMainElement extends TCommonObjectElement {
	...
	function ElemInit(){
		$this->elem_str['address']		= array('Расположение',				'Address');
		$this->elem_str['hot']			= array('Отображать анонс',			'Show anonce');
		$this->elem_str['total_area']	= array('Площадь',					'Square');
		$this->elem_str['purpose']		= array('Назначение',				'Purpose');
		$this->elem_str['transaction_type']			= array('Тип сделки',	'Transaction type');
