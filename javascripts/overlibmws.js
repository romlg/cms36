...
if(OLud('fgcolor'))var ol_fgcolor="#fff";
if(OLud('bgcolor'))var ol_bgcolor="#fff";
if(OLud('cgcolor'))var ol_cgcolor="#fff";
...
if(OLud('width'))var ol_width=450;
if(OLud('wrap'))var ol_wrap=0;
if(OLud('wrapmax'))var ol_wrapmax=0;
if(OLud('height'))var ol_height= 400;
...
var t;if(hasfullhtml){t=txt;}else{t=OLlgfUtil(0,0,o3_textfontclass,'div',o3_textcolor,o3_textfont,o3_textsize)+txt+OLlgfUtil(1,0,'','div');}
