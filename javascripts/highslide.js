...
updateAnchors : function() {
	...
	var els = document.getElementsByClassName('highslide'), all = [], images = [],groups = {}, re;
	}
	else {
...
imageCreate : function() {
	...
	// Картинка с лупой
	var img_lupa = document.createElement('img');
	img_lupa.className = "zoom";
	img_lupa.src = "/images/zoomout.gif";
	this.wrapper.appendChild(img_lupa);
